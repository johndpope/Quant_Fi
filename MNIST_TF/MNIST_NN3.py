...
# np.sqrt(2.0 / (784+L)) Implentation of He & al. Initilization
...
datavis.animate(training_step, iterations=5000, train_data_update_freq=20, test_data_update_freq=100, more_tests_at_start=True)
